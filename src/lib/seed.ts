...
export function seedData(): AppData {
  ...
  return {
    ...
    clients: [
      {
        id: clientA,
        name: "Игорь Покровский",
        company: "Vintage AI",
        status: "active",
        revenue: 180000,
        expectedPayment: 90000,
        payments: [
          { id: uid(), amount: 90000, status: "paid", date: daysAgoDate(50) },
          { id: uid(), amount: 90000, status: "paid", date: daysAgoDate(20) },
          { id: uid(), amount: 90000, status: "pending", date: daysFromNow(5) },
        ],
        tags: ["ретейнер"],
        contacts: [],
        customFields: [],
      ...
      {
        id: clientB,
        name: "Алёна Скворцова",
        company: "Foam Studio",
        status: "active",
        revenue: 120000,
        expectedPayment: 60000,
        payments: [
          { id: uid(), amount: 60000, status: "paid", date: daysAgoDate(12) },
          { id: uid(), amount: 60000, status: "pending", date: daysAgoDate(3) },
        ],
        tags: [],
        contacts: [],
        customFields: [],
    ...
    projects: [
      { id: projectA, name: "Демо дашборда", status: "active", clientId: clientA, createdAt: daysAgo(10) },
      { id: projectB, name: "Редизайн карточки", status: "active", clientId: clientB, createdAt: daysAgo(5) },
